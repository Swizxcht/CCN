...
const navItems = [
  ...
  { to: "/dashboard/customers", label: "Users", icon: UserIcon },
  {
    to: "/dashboard/service-requests",
    label: "Service Requests",
    icon: ServiceRequestIcon,
  },
  { to: "/dashboard/news", label: "News", icon: NewsIcon },
  { to: "/dashboard/subscribers", label: "Subscribers", icon: SubscriberIcon },
  {
    to: "/dashboard/pending-applications",
    label: "Pending Applications",
    icon: PendingIcon,
  },
  { to: "/dashboard/bills", label: "Bills", icon: BillIcon },
  { to: "/dashboard/billing-console", label: "Billing Console", icon: BillingIcon },
  { to: "/dashboard/payments", label: "Payments", icon: PaymentIcon },
  {
    to: "/dashboard/record-payment",
    label: "Record Payment",
    icon: RecordPaymentIcon,
  },
];

function DashboardSidebar({ open = false, onClose = () => {} }) {
    ...
    <>
      ...
      <div className="flex items-center gap-3 border-b border-white/10 p-5">
        ...
        <div>
          ...
          <h2 className="mt-1 text-xl font-black">Control Center</h2>
        </div>
        <button
          type="button"
          onClick={onClose}
